...
/* these are for block devices, and otherwise missing posix attributes /
 * defines for posix properties throwing these here enables us to more closely
 * use upstream files instead of deviating every file that requires them */
