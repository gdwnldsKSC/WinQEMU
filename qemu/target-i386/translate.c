...
#ifdef _MSC_VER
/* The Windows SDK's dlgs.h (dialog control IDs, reached via windows.h) does
 *   #define grp2 0x0431
 * which collides with the "grp2:" goto label used by the shift-group decode
 * below (expanding it to the invalid "0x0431:").  Drop the SDK macro. */
#undef grp2
#endif
