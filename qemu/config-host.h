...
#define QEMU_VERSION "0.10.90"
#define QEMU_PKGVERSION "MS-VisualStudio-2022"
#define CONFIG_UNAME_RELEASE ""
#define AUDIO_DRIVERS \

// above define and blank are normally generated by configure, but since 
// we aren't using that.... here we go to make audio.c compile without modification
