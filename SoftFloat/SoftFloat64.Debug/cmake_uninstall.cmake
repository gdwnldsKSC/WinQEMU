...
if( NOT EXISTS "C:/Users/hunterkll/Documents/GitHub/WinQEMU/SoftFloat/SoftFloat64.Debug/install_manifest.txt" )

    message( FATAL_ERROR "Cannot find install manifest: C:/Users/hunterkll/Documents/GitHub/WinQEMU/SoftFloat/SoftFloat64.Debug/install_manifest.txt" )

endif()

file( READ "C:/Users/hunterkll/Documents/GitHub/WinQEMU/SoftFloat/SoftFloat64.Debug/install_manifest.txt" files )
...
foreach( file ${files} )
    ...
    if( IS_SYMLINK "${_this_file}" OR EXISTS "${_this_file}" )
        ...
        execute_process( COMMAND "C:/Program Files/CMake/bin/cmake.exe" -E remove "${_this_file}"
